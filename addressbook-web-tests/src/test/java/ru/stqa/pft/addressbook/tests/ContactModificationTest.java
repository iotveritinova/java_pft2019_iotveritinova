...
public class ContactModificationTest extends TestBase {
  ...
  public void testContactModification() throws Exception {
    ...
    ContactData newContact = new ContactData("changedName", "changedPatronim", "changedSurname", "new address", "888-000-000", "777-77-22-22", "newEmail@mail.ru", null);
    app.getContactHelper().fillContactData(newContact, false);
